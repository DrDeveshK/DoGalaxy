<?php
get_header();
$q = new WP_Query(['post_type'=>'listing','post_status'=>'publish','posts_per_page'=>12,'s'=>sanitize_text_field(wp_unslash($_GET['q'] ?? ''))]);
if (!empty($_GET['city'])) {
    $q = new WP_Query(['post_type'=>'listing','post_status'=>'publish','posts_per_page'=>12,'meta_key'=>'city','meta_value'=>sanitize_text_field(wp_unslash($_GET['city'])),'meta_compare'=>'LIKE']);
}
?>
