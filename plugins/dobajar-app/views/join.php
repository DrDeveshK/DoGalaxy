...
<section class="ud-split">
  <div><p class="ud-kicker">Join</p><h1>Open a stall</h1><p class="ud-lede">Sellers from Do Udyog get a stall. Buyers browse and request an order — the commerce layer of Do Galaxy.</p></div>
  <form class="ud-form" method="post" action="<?php echo esc_url(admin_url('admin-post.php')); ?>">
    ...
    <input type="hidden" name="action" value="dobajar_register">
    <?php wp_nonce_field('dobajar_register', '_n'); ?>
