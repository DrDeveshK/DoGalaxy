...
<section class="ud-split">
  <div><p class="ud-kicker">Join</p><h1>List a venue</h1><p class="ud-lede">Partners list venues and services. Families and firms send an event request with date and guest count.</p></div>
  <form class="ud-form" method="post" action="<?php echo esc_url(admin_url('admin-post.php')); ?>">
    ...
    <input type="hidden" name="action" value="doswagat_register">
    <?php wp_nonce_field('doswagat_register', '_n'); ?>
