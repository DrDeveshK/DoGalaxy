...
<section class="ud-split">
  <div><p class="ud-kicker">Join</p><h1>List your stay</h1><p class="ud-lede">Hosts publish rooms and retreats. Guests search and send a stay request with dates.</p></div>
  <form class="ud-form" method="post" action="<?php echo esc_url(admin_url('admin-post.php')); ?>">
    ...
    <input type="hidden" name="action" value="dovishram_register">
    <?php wp_nonce_field('dovishram_register', '_n'); ?>
