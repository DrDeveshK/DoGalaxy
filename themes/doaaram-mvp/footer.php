<footer class="footer"><div class="container footer-grid">
  <div><h3>DoAaram</h3><p>Everyday local services under Do Galaxy.</p></div>
  <div><h4>Platform</h4><a href="/">Home</a><a href="/services">Services</a><a href="/join">Join</a></div>
  <div><h4>Do Galaxy</h4>
...
<div class="container" style="border-top:1px solid rgba(255,255,255,.12);margin-top:28px;padding-top:18px;color:#91a8c8">© <?php echo date('Y'); ?> DoAaram. A Kusumit Universe initiative.</div>
</footer>
